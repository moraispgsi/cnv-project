...
set CLASSPATH=%APP_HOME%\lib\server.jar;%APP_HOME%\lib\inst.jar;%APP_HOME%\lib\MazeRunner.jar

@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" pt.ulisboa.tecnico.meic.cnv.WebServer %CMD_LINE_ARGS%
